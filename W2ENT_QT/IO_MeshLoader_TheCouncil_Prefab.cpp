...
scene::IAnimatedMesh* IO_MeshLoader_TheCouncil_Prefab::createMesh(io::IReadFile* file)
{
    ...
    QFileInfo meshFileInfo = UtilsTheCouncil::findFile(fullMeshFilepath, UtilsTheCouncil::TheCouncil_CEF);
    ...
    foreach (const QJsonValue& nodeValue, nodeList)
    {
        ...
        foreach (const QJsonValue& materialValue, materials)
        {
            ...
            QFileInfo materialFileInfo = findFile(materialPath, UtilsTheCouncil::TheCouncil_JSON);
