    ...
    _ui(new Ui::GUI_MainWindow)
{
    ...
    UtilsQt::deleteInReleaseBuild(_ui->action_other_Dishonored_2_unpacker);
...
{
    const QString qLog = UtilsQtIrr::irrStringToQString(log);
...
void GUI_MainWindow::addMeshes(QStringList filePaths)
{
    for (int i = 0; i < filePaths.size(); ++i)
    {
        ...
        LoggerManager::Instance()->addAndFlush(UtilsQtIrr::qStringToIrrString(QString("Read '") + filePath + "'... "), true);
...
void GUI_MainWindow::initIrrlicht()
{
    ...
    LoggerManager::Instance()->addLineAndFlush(UtilsQtIrr::qStringToIrrString(QString("The Witcher 3D models converter ") + Settings::getAppVersion()), true);
}
...
void GUI_MainWindow::convert()
{
    ...
    if (dir.exists())
    {
        ...
        LoggerManager::Instance()->addAndFlush(UtilsQtIrr::qStringToIrrString("Writing file '" + _ui->lineEdit_exportedFilename->text() + infos._extension + "'... "), true);
...
{
    const io::path filePath = UtilsQtIrr::qStringToIrrPath(path);
...
void GUI_MainWindow::replaceMesh(QString path)
{
    ...
    LoggerManager::Instance()->addAndFlush(UtilsQtIrr::qStringToIrrString(QString("Reading file '") + path + "'... "), true);
...
void GUI_MainWindow::loadRig(QString path)
{
    ...
    bool success = _irrWidget->loadRig(UtilsQtIrr::qStringToIrrPath(path));
    logLoadingResult(success);
...
void GUI_MainWindow::loadAnimations(QString path)
{
    ...
    bool success = _irrWidget->loadAnims(UtilsQtIrr::qStringToIrrPath(path));
    logLoadingResult(success);
...
void GUI_MainWindow::loadTW1Animations(QString path)
{
    ...
    bool success = _irrWidget->loadTW1Anims(UtilsQtIrr::qStringToIrrPath(path));
    logLoadingResult(success);
...
void GUI_MainWindow::loadTheCouncilTemplate(QString path)
{
    ...
    bool success = _irrWidget->loadTheCouncilTemplate(UtilsQtIrr::qStringToIrrPath(path));
    logLoadingResult(success);
}
